...
and mastering the slicing syntax is a powerful shortcut for data manipulation that would take 5-10 lines 
...
word = input("Given Input: text = ")

new_word = word[::-1]

print(f"Expected Output: Reversed: {new_word}")