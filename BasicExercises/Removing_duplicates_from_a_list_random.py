"""
Practice Problem: Write a script that takes a random list containing duplicate items and 
...
data = [random.randint(38, 67) for _ in range(16)]
print(f"data = {data}")
my_set = list(set(data))

print(f"unique = {my_set}")
