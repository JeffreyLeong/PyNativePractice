"""
Practice Problem: Print the following pattern where each row contains a number 
repeated a specific number of times based on its value.
...
rows = int(input("Enter the number of rows you want to see: "))
